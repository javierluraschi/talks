...
image_response <- RoogleVision::getGoogleVisionResponse("http://pbs.twimg.com/media/DwzRq1zWkAEpEcU.jpg")
image_response
```

```{r}
knitr::include_graphics("http://pbs.twimg.com/media/DwzRq1zWkAEpEcU.jpg")
```
