...
![](images/spark-scale-out-scale-up.png)
...
![](images/realtime-spark-r-twitter.png)
...
```{r}
cars_str <- stream_read_csv(sc, "cars", "mtcars/")     # Read stream in Spark
```
...
reactiveSpark(out_str)                                 # Transform into a Shiny reactive
```
...
![](images/streaming-kafka-spark-shiny.png)
...
![](images/sparklur-rstudio-1.2-features.png)
...
> Apache Arropw is a cross-language development platform for in-memory data.
