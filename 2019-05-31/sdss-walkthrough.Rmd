...
image_response <- RoogleVision::getGoogleVisionResponse("https://pbs.twimg.com/media/D7w0B7YU8AEi2dj.jpg")
image_response
```

```{r}
knitr::include_graphics("https://pbs.twimg.com/media/D7w0B7YU8AEi2dj.jpg")
```
...
```{r}
wordcloud::wordcloud(tags$word, tags$total, scale = c(4, 0.5),
                     min.freq = 1, max.words = 50)
```
