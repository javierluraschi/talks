...
tweets <- produce_tweets("#SDSS2019", producer, "tweets")
```
...
image_response <- RoogleVision::getGoogleVisionResponse("https://pbs.twimg.com/media/D75h6JlU0AAkev_.jpg")
image_response
```

```{r}
knitr::include_graphics("https://pbs.twimg.com/media/D75h6JlU0AAkev_.jpg")
```
