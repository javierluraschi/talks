...
<!--<img src="images/hex-sparklyr.svg" style="float: left; width: 70px; box-shadow: none;"/>-->
```{r}
library(sparklyr)
sc <- spark_connect(master = "local|yarn|mesos|spark|livy")
flights <- copy_to(sc, flights)
```
<!--<img src="images/hex-dplyr.png" style="float: left; width: 70px; box-shadow: none;"/>-->
```{r}
library(dplyr)
flights %>%
  group_by(month, day) %>%
...
<img src="images/delta-lake-diagram.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
sdf_len(sc, 5) %>% spark_write_delta(path = "/tmp/delta-1")
sdf_len(sc, 2) %>% spark_write_delta(path = "/tmp/delta-1", mode = "overwrite")

spark_read_delta(sc, "/tmp/delta-1")
```
```{text class.source='sourceCode'}
...
<img src="images/sparklyr-1-1-extensions.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/clusters-qubole-sparklyr.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/barrier-execution.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/mlflow-tesla-example.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/mastering-spark-with-r.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/sparklyr-community.png" style="width: 70%; margin-left: auto; margin-right: auto;">
...
<img src="images/sparklyr-linux-foundation.png" style="width: 70%; margin-left: auto; margin-right: auto;">
